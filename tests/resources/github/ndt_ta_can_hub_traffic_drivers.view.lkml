view: ndt_ta_can_hub_traffic_drivers {
  derived_table: {
    explore_source: sdt_dcm {
      ...
      column: total_impressions {field: sdt_fy20_ta_can_hub_traffic_drivers.total_impressions}
      column: total_clicks {field: sdt_fy20_ta_can_hub_traffic_drivers.total_clicks}
      column: total_views {field: sdt_fy20_ta_can_hub_traffic_drivers.total_views}
      column: total_completes {field: sdt_fy20_ta_can_hub_traffic_drivers.total_completes}
      column: total_cost {field: sdt_fy20_ta_can_hub_traffic_drivers.total_cost}
      filters: {

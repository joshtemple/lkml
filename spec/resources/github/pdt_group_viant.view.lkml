view: pdt_group_viant {
  derived_table: {
    explore_source: vnv_dcm {
      ...
      column: total_impressions {field: vnv_fy20_group_viant.total_impressions}
      column: total_clicks {field: vnv_fy20_group_viant.total_clicks}
      column: total_views {field: vnv_fy20_group_viant.total_video_views}
      column: total_completes {field: vnv_fy20_group_viant.total_video_completes}
      column: total_cost {field: vnv_fy20_group_viant.total_media_cost}
      ...
      column: total_partner_referrals {field: vnv_dcm_ga_view.total_partner_referral}
      filters: {

view: ndt_ta_us_destination_sponsorship {
  derived_table: {
    explore_source: sdt_dcm {
      ...
      column: total_impressions {field: sdt_fy20_ta_us_destination_sponsorship.total_impressions}
      column: total_clicks {field: sdt_fy20_ta_us_destination_sponsorship.total_clicks}
      column: total_views {field: sdt_fy20_ta_us_destination_sponsorship.total_views}
      column: total_completes {field: sdt_fy20_ta_us_destination_sponsorship.total_completes}
      column: total_cost {field: sdt_fy20_ta_us_destination_sponsorship.total_cost}
      filters: {

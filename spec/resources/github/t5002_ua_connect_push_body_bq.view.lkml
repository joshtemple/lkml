view: t5002_ua_connect_push_body_bq {
  sql_table_name: UA_CONNECT.t5002_ua_connect_push_body ;;
  ...
  dimension_group: c5002_occurred {
    ...
    convert_tz: no
    datatype: date
    sql: CAST(${TABLE}.c5002_occurred_time AS TIMESTAMP) ;;
  }
  ...
  dimension_group: c5002_processed {
    ...
    convert_tz: no
    datatype: date
    sql: CAST(${TABLE}.c5002_processed_time AS TIMESTAMP) ;;
  }
